...
import ProAlgoCSV as AC  # ALGOCSV permet de générer un csv en fonction du nombre de cellules choisies par l'utilisateur
...
Label(Fenetre, text="Probabilité:").grid(row = 6, column = 0, sticky = "n") 
textBoxProba.grid(row = 7, column = 0, sticky = "n")
